...
//        surfaceView.setBackgroundColor(R.color.black_a10_color);
    ...
    public void setUp(String url, String thumb, String title, boolean ifShowTitle) {
        ...
        if (ifFullScreen) {
            ...
            ivFullScreen.setImageResource(shrinkRecId == 0 ? R.drawable.fullscrin : shrinkRecId);
        ...
        Log.i("aiya", "setUp: "+"laile");
        Log.i("aiyau", "setUp: "+thumb);
        ...
        createVideoThumbnail(thumb,100,100);
    }

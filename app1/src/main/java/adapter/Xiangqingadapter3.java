...
import view.SearchPagerGaoview5;

/**
 * Created by 胡海波 on 2016/8/23.
 */
public class Xiangqingadapter3 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private LayoutInflater inflater;
    private ImageLoader loader;
    private ArrayList<xiangqingbean3.ResponseJsonBean.ListProductBean> xqbean3=new ArrayList<>();
    public Xiangqingadapter3(Context context, ImageLoader loader){
        inflater=LayoutInflater.from(context);
        this.loader=loader;
    }
    public void updatexqbean3 (ArrayList<xiangqingbean3.ResponseJsonBean.ListProductBean> xqbean3){
        this.xqbean3=xqbean3;
        Log.i("msng", "updatexqbean: "+xqbean3);
    }
    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case 0:
                holder=new mXiangqing(inflater.inflate(R.layout.search_more5,parent,false));
                break;
            case 1:
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (getItemViewType(position)){
            case 0:
                ...
                if(xqbean3!=null){
                    mxholder.gaoview5.updatePager5(xqbean3,loader);
                }
                break;
            case 1:
                mXiangqing1 mxholder1= (mXiangqing1) holder;

                for (int i = 0; i <xqbean3.size() ; i++) {
                    String ss=xqbean3.get(0).getProduct_name();
                    String hh2=String.valueOf( xqbean3.get(0).getProduct_nowprice());
                    String hh4=String.valueOf(xqbean3.get(0).getProduct_price());
            ...
            case 2:
                ...
                for (int i = 0; i < xqbean3.size(); i++) {
                    String hh3=String.valueOf(xqbean3.get(0).getProduct_stock());
    ...
    public int getItemCount() {
        int count=xqbean3==null?0:xqbean3.size()+3;
        return count;
    }
    class mXiangqing  extends   RecyclerView.ViewHolder{
        SearchPagerGaoview5 gaoview5;
        public mXiangqing(View itemView) {
            super(itemView);
            gaoview5= (SearchPagerGaoview5) itemView.findViewById(R.id.searchmoregaoview5);
        }
    }

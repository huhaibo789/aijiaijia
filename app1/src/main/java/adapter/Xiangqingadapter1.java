 ...
 */
public class Xiangqingadapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private LayoutInflater inflater;
    private ImageLoader loader;
    private ArrayList<xiangqingbean1.ResponseJsonBean.ListProductBean> xqbean1=new ArrayList<>();
    public Xiangqingadapter1(Context context, ImageLoader loader){
        inflater=LayoutInflater.from(context);
        this.loader=loader;
    }
    public void updatexqbean (ArrayList<xiangqingbean1.ResponseJsonBean.ListProductBean> xqbean1){
        this.xqbean1=xqbean1;
        Log.i("msng", "updatexqbean: "+xqbean1);
    }
    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case 0:
                holder=new mXiangqing(inflater.inflate(R.layout.search_more1,parent,false));
                break;
            case 1:
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (getItemViewType(position)){
            case 0:
                ...
                if(xqbean1!=null){
                    mxholder.gaoview3.updatePager2(xqbean1,loader);
                }
                break;
            case 1:
                mXiangqing1 mxholder1= (mXiangqing1) holder;

                for (int i = 0; i <xqbean1.size() ; i++) {
                    String ss=xqbean1.get(0).getProduct_name();
                    String hh2=String.valueOf( xqbean1.get(0).getProduct_nowprice());
                    String hh4=String.valueOf(xqbean1.get(0).getProduct_price());
                ...
                /*mxholder1.xq_iv.setImageResource(R.mipmap.ic_launcher);
                mxholder1.xq_iv1.setImageResource(R.mipmap.ic_launcher);*/
                break;
            case 2:
                mXiangqing2 mxholder2= (mXiangqing2) holder;
                for (int i = 0; i < xqbean1.size(); i++) {
                    String hh3=String.valueOf(xqbean1.get(0).getProduct_stock());
            ...
            case 3:
               ...
               /* mxholder3.arrive_iv.setImageResource(R.mipmap.ic_launcher);
                mxholder3.buy_iv.setImageResource(R.mipmap.ic_launcher);
                mxholder3.shop_iv.setImageResource(R.mipmap.ic_launcher);*/
                break;
        }
    }
    ...
    public int getItemCount() {
        int count=xqbean1==null?0:xqbean1.size()+3;
        return count;
    }
    class mXiangqing  extends   RecyclerView.ViewHolder{
        SearchPagerGaoview3 gaoview3;
        public mXiangqing(View itemView) {
            super(itemView);
            gaoview3= (SearchPagerGaoview3) itemView.findViewById(R.id.searchmoregaoview1);
        }
    }

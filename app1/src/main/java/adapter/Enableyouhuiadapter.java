...
/**
 * Created by 胡海波 on 2016/10/13.
 */
public class Enableyouhuiadapter extends BaseAdapter {
    ...
    public Enableyouhuiadapter (Context context, ImageLoader loader){
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ViewHold vh = null;
        if(convertView==null){
            convertView=View.inflate(context, R.layout.activity_enableyouhui,null);
            vh=new ViewHold();

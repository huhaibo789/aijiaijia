 ...
 */
public class newMyHorizontallyScrolley extends HorizontalScrollView implements
        View.OnClickListener
{
     ...
     * 数据适配器
     */
    private newHorizontalScrollViewAdapter mAdapter;
    /**
     * 每屏幕最多显示的个数
     */
    ...
    public newMyHorizontallyScrolley(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        // 获得屏幕宽度
...
//			mContainer = (LinearLayout) getChildAt(0);
     ...
     * @param mAdapter
     */
    public void initDatas(newHorizontalScrollViewAdapter mAdapter)
    {

...
public class ScrollViewContainer extends RelativeLayout {
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			if (vt == null)
				vt = VelocityTracker.obtain();//���VelocityTracker��ʵ�� 
			else
				vt.clear();
			mLastY = ev.getY();
		...
		case MotionEvent.ACTION_MOVE:
			vt.addMovement(ev);//���¼����뵽VelocityTracker��ʵ����
			if (canPullUp && mCurrentViewIndex == 0 && mEvents == 0) {
				mMoveLen += (ev.getY() - mLastY);
				System.out.println("---ACTION_MOVE-mLastY------"+ev.getY());
				// ��ֹ����Խ��
				if (mMoveLen > 0) {
					mMoveLen = 0;
					mCurrentViewIndex = 0;
		...
		case MotionEvent.ACTION_UP:
			mLastY = ev.getY();
			vt.addMovement(ev);
			//����units  ����Ҫָ���ĵõ����ٶȵ�λ�����ֵΪ1�����1�����˶��˶������ء����ֵΪ1000����� 1�����˶��˶�������
			vt.computeCurrentVelocity(700);
			// ��ȡY������ٶ� ����ͨ��getXVelocity()��getYVelocity()��ú�������������

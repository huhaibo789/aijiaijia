 ...
 */
public class h5Scroller extends RelativeLayout {
    ...
    public h5Scroller(Context context) {
        super(context);
        init();
    }

    public h5Scroller(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public h5Scroller(Context context, AttributeSet attrs, int defStyle) {

 ...
 */
public class SearchPagerGaoview4 extends LinearLayout {
    ...
    private  ArrayList<xiangqingbean2.ResponseJsonBean.ListProductBean> xqbean1;
    private ArrayList<View> pagerList1=new ArrayList<>();
    private ImageLoader loader;
    public SearchPagerGaoview4(Context context) {
        super(context);
        init(context);
    }
    public SearchPagerGaoview4(Context context, AttributeSet attrs){
        super(context,attrs);
        init(context);
...
//                }
    ...
    public  void updatePager3(ArrayList<xiangqingbean2.ResponseJsonBean.ListProductBean> xqbean1, ImageLoader loader){

        ArrayList<String> cc=new ArrayList<String>();
        cc.add("http://imgs.aijiaijia.com/product/2016-08-12/pro_fec3f5.jpg");
        cc.add("http://imgs.aijiaijia.com/product/2016-08-12/pro_4222c6.jpg");
        cc.add( "http://imgs.aijiaijia.com/product/2016-08-12/pro_91bf2f.jpg");
        cc.add("http://imgs.aijiaijia.com/product/2016-08-12/pro_c0a44c.jpg");
        cc.add( "http://imgs.aijiaijia.com/product/2016-08-12/pro_1d5108.jpg");
        this.xqbean1=xqbean1;
        Log.i("wan", "updatePager: "+xqbean1.toString());
        for (int i = 0; i <5 ; i++) {
            Log.i("gangan1", "updatePager1: "+xqbean1.size());
            View view=LayoutInflater.from(context).inflate(R.layout.search_page_item,null);
            ImageView iv1= (ImageView) view.findViewById(R.id.pager_iv1);

 ...
 */
public class SearchPagerGaoview3 extends LinearLayout {
    ...
    private  ArrayList<xiangqingbean1.ResponseJsonBean.ListProductBean> xqbean1;
    private ArrayList<View> pagerList1=new ArrayList<>();
    private ImageLoader loader;
    public SearchPagerGaoview3(Context context) {
        super(context);
        init(context);
    }
    public SearchPagerGaoview3(Context context, AttributeSet attrs){
        super(context,attrs);
        init(context);
...
//                }
    ...
    public  void updatePager2(ArrayList<xiangqingbean1.ResponseJsonBean.ListProductBean> xqbean1, ImageLoader loader){

        ArrayList<String> cc=new ArrayList<String>();
        cc.add("http://imgs.aijiaijia.com/product/2016-08-23/pro_fc491c.jpg");
        cc.add("http://imgs.aijiaijia.com/product/2016-08-23/pro_bb2c41.jpg");
        cc.add( "http://imgs.aijiaijia.com/product/2016-08-23/pro_bf67b3.jpg");
        cc.add("http://imgs.aijiaijia.com/product/2016-08-12/pro_9d910b.jpg");
        cc.add( "http://imgs.aijiaijia.com/product/2016-08-12/pro_c6a7f8.jpg");

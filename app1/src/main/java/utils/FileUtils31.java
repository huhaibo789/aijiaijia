...
public class FileUtils31 {
    public static void saveDataToFile(Context context, String data1) {
        try {
            ...
            // mode代表的是打开模式
            FileOutputStream fos = context.openFileOutput("test45.txt", Context.MODE_PRIVATE);
    ...
    public static String readDataFromFile(Context context) {
        try {
            ...
            FileInputStream fis = context.openFileInput("test45.txt");

...
/**
 * Created by misshu on 2017/6/1/001.
 */
public class FileUtils32 {
    public static void saveDataToFile(Context context, String data1) {
        try {
            ...
            // mode代表的是打开模式
            FileOutputStream fos = context.openFileOutput("test46.txt", Context.MODE_PRIVATE);
    ...
    public static String readDataFromFile(Context context) {
        try {
            ...
            FileInputStream fis = context.openFileInput("test46.txt");

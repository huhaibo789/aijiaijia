...
/**
 * Created by 胡海波 on 2016/10/12.
 */
public class FileUtils20 {
    /**
     * 将数据保存到文件
     */
    public static void saveDataToFile(Context context, String data1) {
        try {
            ...
            // mode代表的是打开模式
            FileOutputStream fos = context.openFileOutput("test34.txt", Context.MODE_PRIVATE);
    ...
    public static String readDataFromFile(Context context) {
        try {
            ...
            FileInputStream fis = context.openFileInput("test34.txt");

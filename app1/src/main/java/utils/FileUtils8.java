...
/**
 * Created by 胡海波 on 2016/10/9.
 */
public class FileUtils8 {
    /**
     * 将数据保存到文件
     */
    public static void saveDataToFile(Context context, String data1) {
        try {
            ...
            // mode代表的是打开模式
            FileOutputStream fos = context.openFileOutput("test22.txt", Context.MODE_PRIVATE);
    ...
    public static String readDataFromFile(Context context) {
        try {
            ...
            FileInputStream fis = context.openFileInput("test22.txt");

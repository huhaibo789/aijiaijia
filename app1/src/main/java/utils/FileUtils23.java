...
/**
 * Created by 胡海波 on 2016/10/25.
 */
public class FileUtils23 {
    ...
    public static void saveDataToFile(Context context, String data1) {
        try {
            ...
            // mode代表的是打开模式
            FileOutputStream fos = context.openFileOutput("test37.txt", Context.MODE_PRIVATE);
    ...
    public static String readDataFromFile(Context context) {
        try {
            ...
            FileInputStream fis = context.openFileInput("test37.txt");
